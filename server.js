...
mongoose.connection.once("open", async () => {
  ...
  try {
    ...
    if (duplicates.length > 0) {
      ...
      console.log(
        "Removed duplicate users for walletAddress: 0x3c44cdddb6a900fa2b585dd299e03d12fa4293bc"
      );
    } else {
      console.log(
        "No duplicate users found for walletAddress: 0x3c44cdddb6a900fa2b585dd299e03d12fa4293bc"
      );
    }
  } catch (error) {
